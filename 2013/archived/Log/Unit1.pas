unit Unit1;        //09/12/2013 finale vers. 5.1.0.16  > WorksLog
interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, StdCtrls,Grids,DBGrids,DB,ABSmain,ComCtrls,ExtCtrls,Buttons, DBCtrls,
  Mask,HTMLHelpViewer,System.UITypes, Datasnap.DBClient,printers;
...
begin
    ...
    if MessageDlg('Do you confirm Work Type (Tag 3) ?',mtConfirmation, mbYesNo,0)=mrNo then
          begin
